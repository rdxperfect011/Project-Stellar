...
def seed_database():
    ...
    if AccommodationCategory.query.count() == 0:
        ...
        standard = AccommodationCategory(
            ...
            capacity=2,
            internal_count=5,
            cover_image="images/standard_room_1.png",
            gallery="images/standard_room_1.png,images/standard_room_bathroom_new.png,images/standard_room_2.png",
            is_active=True
        )
        ...
        deluxe = AccommodationCategory(
            ...
            capacity=3,
            internal_count=5,
            cover_image="images/deluxe_room.png",
            gallery="images/deluxe_room.png,images/deluxe_room_bathroom_1.jpg,images/deluxe_room_bathroom_2.jpg",
            is_active=True
        )
        ...
        # Triple Room
        triple = AccommodationCategory(
            name="Triple Room",
            description="Spacious triple-occupancy room featuring a double bed and a single bed, fitted with air conditioning and a ceiling fan. Includes a private attached washroom with premium blue marble tiling, overhead shower, and vanity basin.",
            capacity=3,
            internal_count=2,
            cover_image="images/triple_room.png",
            gallery="images/triple_room.png,images/triple_room_washroom.jpg",
            is_active=True
        )
        ac = Amenity(name="AC", icon="wind")
        cf = Amenity(name="Ceiling Fan", icon="fan")
        aw = Amenity(name="Attached Washroom", icon="droplet")
        db.session.add_all([ac, cf, aw])
        triple.amenities.extend([ac, cf, aw])
        db.session.add(triple)

        # Four-Bed Room
        fourbed = AccommodationCategory(
            name="Four-Bed Room",
            description="Generously sized room accommodating four guests, ideal for families or groups. Features premium furnishings and a private attached washroom.",
            capacity=4,
            internal_count=2,
            cover_image="images/fourbed_room.png",
            gallery="images/fourbed_room.png,images/fourbed_room_washroom.jpg",
            is_active=True
        )
        fourbed.amenities.extend([ac, cf, aw])
        db.session.add(fourbed)
